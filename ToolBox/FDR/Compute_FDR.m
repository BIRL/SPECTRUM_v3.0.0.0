...
unsortedDecoyData = readtable( Complete_Decoy_File , 'Delimiter', ',' );%modified 05042020
unsortedTargetData = readtable( Complete_Taregt_File , 'Delimiter', ',' ); %modified 05042020

DecoyData = sortrows(unsortedDecoyData, 7, 'descend');
TargetData = sortrows(unsortedTargetData, 7, 'descend');

Decoy = [];
for i = 1:size(DecoyData.FileName,1)
