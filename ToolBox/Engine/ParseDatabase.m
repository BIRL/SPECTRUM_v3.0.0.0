...
for Num_Protein = 1:NumEntries
    ...
    eHeader = string(extractBetween(Header, '|','|'));
%     if (strcmp(eHeader, "P77481") || strcmp(eHeader, "P37760") || strcmp(eHeader, "P0A7H6") || strcmp(eHeader, "P0A817") || strcmp(eHeader, "P77671"))
       
        %         if strcmp(string(Protein.Header), ">XXX_sp|Q6BEX5|YJDP_ECOLI Uncharacterized protein YjdP OS=Escherichia coli (strain K12) OX=83333 GN=yjdP PE=3 SV=1")
        %             qwed = 1;
        %         end
