...
% % %                         
                ...
                %%if score same take all
                score= data{1,4};

                for z = 2: size(data(:,4),1)
                    if data{z,4} == score
                        csvData = [csvData; {DirectoryContents(b).name},headerRegex,{data{z,19}},{data{z,5}},{data{z,20}},{data{z,21}},data{z,4},{data{z,3}},numel(data{z,7}),{data{z,18}},tElapsed,{data{z,22}},{data{z,23}},{data{z,24}},{data{z,25}},{data{z,26}},{data{z,27}},{data{z,28}},{data{z,29}},{data{z,30}},{data{z,31}},{data{z,32}}]; %#ok<AGROW>
                    end
                end
