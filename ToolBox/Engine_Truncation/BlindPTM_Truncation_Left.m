...
%     ExperimentalSpectrum = sortrows(getappdata(0,'Comp_Peaklist_Data')); %modified 08042020
    
    % Experimental peak extraction and peak fliping.
    %%% Updated 20210409   %% BELOW
    PeakListMW_Comp = getappdata(0,'Comp_Fragments_Masses');
    Intensity_Comp = getappdata(0,'Comp_Int');
    ExperimentalSpectrum = [PeakListMW_Comp, Intensity_Comp];%sortrows(getappdata(0,'Peaklist_Data'));
    %%% Updated 20210409   %% ABOVE

else
%     ExperimentalSpectrum = sortrows(getappdata(0,'Peaklist_Data')); %modified 08042020
